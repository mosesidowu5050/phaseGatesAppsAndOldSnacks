...
public class BankPrototype {
    ...
    public static void depositMoney() {
        ...
        Account userAccount = atm.findAccountByAccountNumber(accountNumber);
    ...
    public static void transferMoney() {
        ...
        Account receiverAccount = atm.findAccountByAccountNumber(receiverAccountNumber);
        Account senderAccount = atm.findAccountByAccountNumber(accountNumber);

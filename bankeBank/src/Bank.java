...
public class Bank {
    ...
    public String createAccount(String firstName, String lastName, String pin) {
        ...
        Account account = new Account(firstName, lastName, pin, accountNumbersGenerator);
    ...
    public double getBalance(String pin, Account accountBalance) {
    ...
    public void closeAccount(String pin, Account bankAccount) {
        if (bankAccount == null) {
